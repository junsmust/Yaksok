...
public class FirebaseMessageService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        Log.e( "onMessageReceived: ","메시지 왔어요");
     ...
     /*   Log.d("chat", title + "   " + message);
        ...
        if (User_Id.getUser_Id() == null) {
            ...
            if (!Chat_Room.iInTheChattingRoom) {
                ...
                Chat_Room.user_id = decodeId;
                Chat_Room.my_id = User_Id.getUser_Id();
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {  // Runnable 의 Run() 메소드에서 UI 접근
                        SendMessageVO sendVO = new SendMessageVO(decodeId, decodeMessage, User_Id.getUser_Id(), decodeRegiDate.substring(11, 16));

                        if (Chat_Room.my_id.equals(sendVO.getGivingUser())) {
                            chat_presenter.sendSendVO(sendVO);
                            Log.e(TAG, "run: " + sendVO.getContent());
                            chat_presenter.onResponse(true);

                            // chat_presenter.sendChatArrayList(Chat_Room.albumList);
                           ...
                           *//* Chat_Room.linearLayoutManager.setStackFromEnd(true);
                            Chat_Room.chat_recycler_list.setAdapter(Chat_Room.myRecyclerAdapter);
